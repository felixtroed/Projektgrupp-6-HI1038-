...
typedef struct udpData {
	...
	int idx, x, y, frame, nrOfClients, isHurt, isDead, powerCol, powerRow, powerUpGone, bombDropped, bombPosX, bombPosY, explosionRange,
		rowBoxOne,colBoxOne, valueBoxOne, rowBoxTwo, colBoxTwo, valueBoxTwo, rowBoxThree, colBoxThree, valueBoxThree;
} *udpData;
...
void sendData(UDPsocket sd, UDPpacket* pReceive, UDPpacket* pSend, udpData data, Uint32 clientIP, Uint32 clientPort) {
	...
	sscanf((char*)pReceive->data, "%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n",
		...
		&data->valueBoxOne, &data->colBoxOne, &data->rowBoxOne,
		&data->valueBoxTwo, &data->colBoxTwo, &data->rowBoxTwo,
		&data->valueBoxThree, &data->colBoxThree, &data->rowBoxThree
	);
	// printf("boxCol: %d boxRow: %d \n", data->boxCol, data->boxRow);
	sprintf((char*)pSend->data, "%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n", data->idx, data->x, data->y, data->frame, data->nrOfClients, data->isHurt, data->isDead, data->powerCol, data->powerRow,
		data->powerUpGone, data->bombDropped, data->bombPosX, data->bombPosY, data->explosionRange,
		data->valueBoxOne, data->colBoxOne, data->rowBoxOne,
		data->valueBoxTwo, data->colBoxTwo, data->rowBoxTwo,
		data->valueBoxThree, data->colBoxThree, data->rowBoxThree
	);
